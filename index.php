...
<html>
  <head>
    ...
    <title>Yvvs</title>
    <meta name="title" content="Yvvs portfolio | Yvo van Oosterum">
    <meta name="description" content="Yvo is a concept developer, UX &amp; UI designer and web developer living in Amsterdam. On the portfolio you can find some of his projects.">
    <meta name="keywords" content="One Caring World Famine Africa Donation ">
    <meta property="og:url" content="http://www.yvvs.nl">
    <meta property="og:type" content="website">
    <meta property="og:title" content="Yvvs portfolio | Yvo van Oosterum">
    <meta property="og:description" content="Yvo is a concept developer, UX &amp; UI designer and web developer living in Amsterdam. On the portfolio you can find some of his projects.">
    <meta property="og:image" content="http://www.yvvs.nl/images/share.png">
    <meta name="twitter:card" content="summary">
    <meta name="twitter:title" content="Yvvs portfolio | Yvo van Oosterum">
    <meta name="twitter:url" content="http://www.yvvs.nl">
    <meta name="twitter:description" content="Yvo is a concept developer, UX &amp; UI designer and web developer living in Amsterdam. On the portfolio you can find some of his projects.">
    <meta name="twitter:image" content="http://www.yvvs.nl/images/share.png">
    ...
    <script>
      ...
      setTimeout(function() {
      Typed.new('.element', {
      strings: ["Concept developer,", "UX/UI designer,", "Web developer,", "Awesome dude!"],
      typeSpeed: 0
      });
      }, 2500);
      });
  ...
  <body>
    <div class="container-fluid" id="banner">
      <div class="row">
        <div class="hidden-xs">
          <ul class="head fly-in-text1 hidden1">
            <li>Y</li>
            <li>V</li>
            <li>V</li>
            <li>S</li>
    ...
    <div class="container-fluid" id="buttons">
      <button id="toplft"><i class="fa fa-arrow-up fa-1x" aria-hidden="true"></i></button>
      <button id="toprgt"><i class="fa fa-envelope fa-1x" aria-hidden="true"></i></button>
      <button id="toprgt2"><i class="fa fa-times fa-1x" aria-hidden="true"></i></button>
      <button id="btmmdl"><i class="fa fa-arrow-down fa-1x" aria-hidden="true">   </i></button>
    </div>
    ...
    <div class="container-fluid" id="projects">
      <div class="row select hidden-xs">
        <div class="col-sm-3 project nr1">
          <h5 class="blok">EEV</h5>
        </div>
        <div class="col-sm-3 project nr2">
          <h5 class="blok">NEXT</h5>
        </div>
        <div class="col-sm-3 project nr3">
          <h5 class="blok">ONE CARING WORLD</h5>
        </div>
        <div class="col-sm-3 project nr4">
      ...
      <div class="row projectinfo">
        <div class="col-sm-12 project1">
          ...
          <div class="row content2">
            <div class="col-sm-3"><img class="img-responsive phone" src="/images/EEV/maand.png"></div>
            <div class="col-sm-3"><img class="img-responsive phone" src="/images/EEV/event.png"></div>
            <div class="col-sm-3"> <img class="img-responsive phone" src="/images/EEV/attendance.png"></div>
            <div class="col-sm-3"><img class="img-responsive phone" src="/images/EEV/do.png"></div>
          </div>
        </div>
        <div class="col-sm-12 project2">
          <h3>NEXT</h3>
          <p class="tags">Concept Development, UX/UI-design, Prototyping</p>
          <div class="row content">
            <div class="col-sm-4 col-sm-offset-2">
          ...
          <div class="row content2">
            <div class="col-sm-3"><img class="img-responsive phone" src="/images/NEXT/games1.png"></div>
            <div class="col-sm-3"><img class="img-responsive phone" src="/images/NEXT/tinder.png"></div>
            <div class="col-sm-3"> <img class="img-responsive phone" src="/images/NEXT/badge.png"></div>
            <div class="col-sm-3"><img class="img-responsive phone" src="/images/NEXT/studietop.png"></div>
          </div>
        </div>
        <div class="col-sm-12 project3">
          <h3>ONE CARING WORLD</h3>
          ...
          <div class="row content2">
            <div class="col-sm-6"><img class="img-responsive phone" src="/images/OCW/ocw1.png"></div>
            <div class="col-sm-6"><img class="img-responsive phone" src="/images/OCW/ocw2.png"></div>
          </div>
        </div>
        <div class="col-sm-12 project4">
          <h3>Park it</h3>
          ...
          <div class="row content2">
            <div class="col-sm-6"><img class="img-responsive phone" src="/images/PARKIT/admin.png"></div>
            <div class="col-sm-6"><img class="img-responsive phone" src="/images/PARKIT/gebruiker.png"></div>
            <div class="col-sm-6"><img class="img-responsive phone" src="/images/PARKIT/beheerder.png"></div>
            <div class="col-sm-6"><img class="img-responsive phone" src="/images/PARKIT/toezichthouder2.png"></div>
          </div>
        </div>
      </div>
    </div>
